  import AddWishlist from "../../../app/component/AddWishlist";
  ...
  export async function generateMetadata(
    ...
    const product = await fetch(process.env.NEXT_PUBLIC_BASE_URL +`/api/products/${params.slug}`).then((res) => res.json())
  
  
    return {
      title: `Luxora |   ${product.name}`,
  ...
  export default async function page({ params }: { params: { slug: string } }) {
    ...
    if (!res.ok) {
      throw new Error(`Failed to fetch product with slug: ${params.slug}`);
    }
    ...
    return (
      <div className="flex flex-col">
        <div className="bg-lime-900 h-28 w-screen"></div>
            ...
            <div className="p-4 lg:max-w-6xl max-w-2xl max-lg:mx-auto">
              <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-8 max-lg:gap-16">
                <div className="w-full lg:sticky top-0 text-center">
                  <div className="lg:h-[560px] shadow-lg">
                    <img
                ...
                <div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-4 mt-4">
                      {product.tags.map((el: string | number | bigint | boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<AwaitedReactNode> | null | undefined , index: Key | null | undefined) => (
                  ...
                  <AddWishlist  product_Id={product._id.toString()}/>
                  </div>
                </div>
              </div>
